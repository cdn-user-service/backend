...
public class FuiouService {
    ...
    public  Map<String, String> buildFuiou21(){
        ...
        map.put("random_str", RANDOM_NUMBER_GENERATOR.nextBytes().toHex());
        map.put("sign", "");
        ...
        map.put("mchnt_order_no", fuiouConfig.order_prefix+sdf_no.format(calendar.getTime()) + (int)(RANDOM.nextDouble() * 100000));
        map.put("curr_type", "");
        map.put("order_amt", "1");
