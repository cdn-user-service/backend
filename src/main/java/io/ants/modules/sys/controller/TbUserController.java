...
public class TbUserController extends AbstractController{
    ...
    @GetMapping("/detail")
    @PreAuthorize("hasAuthority('app:user:info')")
    ...
    @SysLog("删除用户")
    @PostMapping("/deleta")
    @PreAuthorize("hasAuthority('app:user:delete')")
    ...
    @SysLog("修改用户信息")
    @PostMapping("/modify")
    @PreAuthorize("hasAuthority('app:user:update')")
    ...
    @SysLog("创建用户")
    @PostMapping("/create")
    @PreAuthorize("hasAuthority('app:user:save')")
