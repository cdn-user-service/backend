...
public class TbRewriteController {
     ...
     */
    @RequestMapping("/list")
    @RequiresPermissions("tb:rewrite:list")
    ...
    @RequiresPermissions("tb:rewrite:info")
     ...
     */
    @RequestMapping("/save")
    @RequiresPermissions("tb:rewrite:save")
    ...
    @RequiresPermissions("tb:rewrite:update")
     ...
     */
    @PostMapping("/delete")
    @RequiresPermissions("tb:rewrite:delete")
