...
public class AppWorkOrderController {
    ...
    public R wol_list(@Parameter(hidden = true) @RequestAttribute("userId") Long userId, @RequestBody Map param) {
        ...
        return R.ok().put("data",
                tbWorkOrderService.WOL_PageList(userId, startDate, endDate, urgentLevel, status, page, limit));
    }
    ...
    @UserLog("创建工单")
    public R wol_save(@Parameter(hidden = true) @RequestAttribute("userId") Long userId,
            @RequestBody CreateWorkOrder form) {
    ...
    public R wol_detail(@Parameter(hidden = true) @RequestAttribute("userId") Long userId, Integer id) {
    ...
    @UserLog("修改工单状态")
    public R wol_change_status(@Parameter(hidden = true) @RequestAttribute("userId") Long userId, Integer id,
            Integer status,
            Integer score) {
        if (null == id) {
    ...
    @UserLog("删除工单")
    public R wol_delete(@Parameter(hidden = true) @RequestAttribute("userId") Long userId, @RequestBody Map param) {
    ...
    @UserLog("回复工单")
    public R wo_send_message(@Parameter(hidden = true) @RequestAttribute("userId") Long userId,
