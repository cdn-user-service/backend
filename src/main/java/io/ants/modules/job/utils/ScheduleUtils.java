...
public class ScheduleUtils {
    ...
    private static CronTrigger createDefaultCronTrigger(long jobId) {
        // 创建一个默认的 Cron 表达式，例如每5分钟执行一次
        String defaultCronExpression = "0 */5 * ? * *";
        return TriggerBuilder.newTrigger()
                .withIdentity(getTriggerKey(jobId))
                .withSchedule(CronScheduleBuilder.cronSchedule(defaultCronExpression))
                .build();
    }
    ...
    public static CronTrigger getCronTrigger(Scheduler scheduler, Long jobId) {
        try {
            ...
            e.printStackTrace();
            throw new RRException("getCronTrigger fail", e);
        }
    }
