...
public class QueryAnts {

    private final static Logger logger = LoggerFactory.getLogger(QueryAnts.class);
   ...
   //1=sys;2=source;3=site
    ...
    public static void setZeroSslAccessId(String zeroSslAccessId) {
        QueryAnts.zeroSslAccessId = zeroSslAccessId;
    }

    public static void setZeroSslAccessPwd(String zeroSslAccessPwd) {
        QueryAnts.zeroSslAccessPwd = zeroSslAccessPwd;
    }
    ...
    public static String getNewestVersionInfoAddress(String product_type,String goods, String hash){
        ...
        return QueryAnts.getUpdateLogAddress()+"?p=newest&product_type="+product_type+"&goods="+goods+"&hash="+hash;
    }

    public static String getDocList(String name){
        try{
            return  QueryAnts.getUpdateLogAddress()+"?p=cdn_doc";
            //return QueryAnts.getUpdateLogAddress()+"?p=/v2/public/index.php/product/docs/get_child_from_name&name="+ URLEncoder.encode(name, "UTF-8");
        }catch (Exception e){
            e.printStackTrace();
        }
        return "";
    ...
    public static String getUpdateInfoList(String product_type,String pagenum, String pagesize){
        ...
        return QueryAnts.getUpdateLogAddress()+"?p=updateLog&product_type="+product_type+"&pagenum="+pagenum+"&pagesize="+pagesize;
    }
    ...
    public static String getDownloadInstallNodeAddress(){
    ...
    public  static String antsCdnHttpRequest(Integer method, String url, String param){
        try{
            String res=null;
            if(0==method){
