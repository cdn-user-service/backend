...
public class UserLogAspect {
	...
	private void saveUserLog(ProceedingJoinPoint joinPoint, long time) {
		...
		}else if(-1!=final_method.indexOf("AppSiteController") ||  -1!=final_method.indexOf("AppStreamController") ||  -1!=final_method.indexOf("AppRewriteController")  ||  -1!=final_method.indexOf("AppCertifyController")) {
