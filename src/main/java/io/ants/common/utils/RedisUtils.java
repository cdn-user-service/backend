...
public class RedisUtils {
    ...
    public void byteSet(String key, String filePath) {
        ...
        // redisTemplateBuf.setValueSerializer(new
    ...
    public String streamXAdd(String StreamKey, String key, String value) {
        // 创建消息记录, 以及指定stream
        try {
            StringRecord stringRecord = StreamRecords.string(Collections.singletonMap(key, value))
     ...
     * @return
     */
    public String addRecord(MapRecord<String, String, String> record) {
