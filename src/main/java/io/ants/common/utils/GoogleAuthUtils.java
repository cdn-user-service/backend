...
import io.ants.modules.app.vo.GoogleViewVO;
...
//                throw new RuntimeException(e.getMessage());
    ...
    public static boolean checkCode(String secret, String code){
        return checkCode(secret,Long.parseLong(code), System.currentTimeMillis());
    }
    ...
    public static GoogleViewVO buildOneData(long userId){
        String secretKey= GoogleAuthUtils.getSecretKey();
        String imgTxt= GoogleAuthUtils.getQrCodeText(secretKey,"cdn_system",String.valueOf(userId) );
        GoogleViewVO vo = new GoogleViewVO() ;
        vo.setSecretKey(secretKey);
        vo.setImgBaseDate(QrCodeUtils.creatRrCode(imgTxt,400,400));
        return vo;
    }

    private static void test_func(){
        //secretKey：UYZL5U2J2D6FBG7U
        //code：108076
        //isSuccess：true
    ...
    public static void main(String[] args) {
        //test_create()
        String sk="UYZL5U2J2D6FBG7U";
        String img=QrCodeUtils.creatRrCode(GoogleAuthUtils.getQrCodeText(sk,"cdn_test_account","cdn_test_issuer"),400,400) ;
        System.out.println(img);
        String code="096512";
        System.out.println("code：" + code);
        boolean b = checkCode(sk, Long.parseLong(code), System.currentTimeMillis());
        System.out.println("isSuccess：" + b);
